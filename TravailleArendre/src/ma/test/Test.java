...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Homme h1 = new Homme("Ayoub", "Oifik", "4856978956", "fdfe", new Date(1984 - 1900, 4, 3));
        Homme h2 = new Homme("hnome 1", "hprenome 1", "5548956654", "fgfd", new Date(1994 - 1900, 4, 3));
        Homme h3 = new Homme("hnome 2", "hprenome 2", "54855488", "fdfe", new Date(1987 - 1900, 4, 3));
        ...
        Femme f1 =  new Femme("hanan1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
         Femme f2 =  new Femme("hanan1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
          Femme f3 =  new Femme("hanan1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
           Femme f4 =  new Femme("hanan1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
        Femme f5 =  new Femme("hanan1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
        Femme f6 = new Femme("hanan2", "lol2", "04874884", "grgr", new Date(1995 - 1900, 4, 3));
        Femme f7 =  new Femme("hanan3", "lol3", "04874884", "atebfdfan", new Date(1980 - 1900, 4, 3));
        Femme f8 = new Femme("hanan4", "lol4", "04874884", "grgr", new Date(1979 - 1900, 4, 3));
        Femme f9 =  new Femme("hanan5", "lol5", "04874884", "atebfdfan", new Date(1988 - 1900, 11, 3));
        Femme f10 = new Femme("hanan6", "lol6", "04874884", "grgr", new Date(1984 - 1900, 6, 3));
